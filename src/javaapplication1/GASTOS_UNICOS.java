 ...
 * @author derfu
 */
public class GASTOS_UNICOS extends javax.swing.JFrame {

    /**
     * Creates new form GATOS_UNICO
     */
    public GASTOS_UNICOS() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "FECHA", "NOMBRE DEL GASTO", "VALOR", "TIPO DE GASTO"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jLabel6.setText("SUMAR A PATRIMONIO");
        ...
        jLabel7.setText("GASTOS UNICOS");

        jLabel8.setText("GASTOS PATRIMONIO");
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
       AGREGAR_GASTO_UNICO  agu=new AGREGAR_GASTO_UNICO();
      agu.setVisible(true);
      this.dispose(); // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GASTOS_UNICOS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GASTOS_UNICOS().setVisible(true);
            }
        });
    }
